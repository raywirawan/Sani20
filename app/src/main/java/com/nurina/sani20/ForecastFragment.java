...
public class ForecastFragment extends Fragment {
    ...
    public static String setloc = "Lowokwaru";
    ...
    public void find_weatherDaily(){
        String url2 = "http://api.openweathermap.org/data/2.5/forecast/daily?q=Malang,ID&appid=3805dd8eda02a9e61920a575cd81b269";
...
//        tipsTextView = dialogview.findViewById(R.id.tips);
//        tipsTextView.setText("asuuuu");
        alertDialog.show();
    ...
    private String TipsHujan[] = new String[]{
